...
>
  <ul class="nav threed-tabs" role="tablist" style="display: block">
	...
	<li class="nav-item">
      <a class="nav-link <?php if($activity == 'gokart'){ echo 'active'; } ?>" href="/aktiviteter/gokart/"
        >Gokart</a
      >
    </li>	
	<li class="nav-item">
      <a class="nav-link <?php if($activity == 'dubbla-vingar'){ echo 'active'; } ?>" href="/aktiviteter/dubbla-vingar/"
        >Dubbla vingar</a
      >
    </li>
  </ul>
