...
// if ($(window).width() > 1096 && $("#video").length) {
      ...
      complete: function (data) {
        ...
        if (statusArray.success == 'activated') {
          ...
          Swal.fire({
            icon: 'success',
            title: 'Information',
            text: 'Saldot på ditt kort är ' + statusArray.value + ':-' + friskvard,
            footer: 'Ditt presentkort är giltigt till ' + statusArray.expiryDate,
          });
