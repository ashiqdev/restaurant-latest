          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="text-center">
                <h3
                  class="d-inline-block mx-auto meny-title"
                  data-wow-delay="0.2s"
                  
                >
                  SNACKS
                  <span
                    class="material-icons meny-material"
            ...
            <div class="col-lg-12">
              <div class="text-center mt-4 mb-4 wow pixFadeDown">
                <div class="d-inline-block star-header text-center">
                  <h3
                    class="text-center d-inline-block meny-head"
            ...
            <div class="col-lg-12">
              <div
                class="text-center mb-4 wow pixFadeDown mtop-130"
